...
public class ChatGPTManager : MonoBehaviour
{
    ...
    public void SendMessageToChatGPT()
    {
        ...
        {
            userMessage += "這幅作品是王靜芝的書法，內容為「論書當欲心先正，學到豈容氣不平。」";
        }
        else if (objectID == 2)
        {
            userMessage += "這幅作品是王靜芝的書法，內容為「山半烏雲挾驟雨，湖頭綠漲過平橋。眼前風色添方寸，爭似錢塘八月潮。」";
        }
        else if (objectID == 3)
        {
            userMessage += "這幅作品是王靜芝的書法，內容為「荷盡已無擎雨蓋，菊殘猶有傲霜枝。一年好景君須記，正是橙黃橘綠時。」";
        }
        else if (objectID == 4)
        {
        ...
        {
            userMessage += "這幅作品是宣化上人的書法，內容為「十界一心，不離當念。」，十界一心，不離當念；能覺此念，立登彼岸。「十界一心」：佛、菩薩、聲聞、緣覺，這是四聖法界；天、人、阿修羅、地獄、餓鬼、畜生，這是六凡法界。合起來，叫十法界。這十法界從什麼地方生出來的？就從我們人現前一念心生出來的。「能覺此念」：這十法界沒有離開你這現前一念，你現前的一念你要明白了，「立登彼岸」：立刻就到彼岸了，就「摩訶般若波羅蜜」了。";
        }
